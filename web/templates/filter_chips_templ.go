...
func chipClass(active bool) string {
	if active {
		return "rounded-full px-3 py-1 text-sm bg-gray-800 dark:bg-gray-100 text-white dark:text-gray-900 font-medium"
	}
...
func FilterChips(query string, active string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		for _, chip := range filterChips {
			var templ_7745c5c3_Var2 = []any{chipClass(active == chip.Value)}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `web/templates/filter_chips.templ`, Line: 1, Col: 0}
			}
